...
import TouristAttractionDetailAdminContainer from '../containers/admin/TouristAttraction/TouristAttractionDetailAdminContainer';
...
export const routes = [
  {
    ...
    children: [
      ...
      { path: ROUTE.TOUR_MANAGER, element: <TourManagerContainer /> },
      {
        ...
        element: <TouristAttractionManagerContainer />,
      },
      { path: ROUTE.BOOKING_MANAGER, element: <BookingManagerContainer /> },
      { path: ROUTE.ACCOUNT_MANAGER, element: <AccountManagerContainer /> },
      {
        path: ROUTE.TOURIST_ATTRACTION_DETAIL_ADMIN,
        element: <TouristAttractionDetailAdminContainer />,
      },
      {
        path: ROUTE.TOURIST_ATTRACTION_CREATE,
        element: <TouristAttractionCreateContainer />,
      },
      {
        path: ROUTE.TOUR_DETAILS_ADMIN,
        element: <TourDetailsAdminContainer />,
      },
      { path: ROUTE.TOUR_CREATE, element: <TourCreateContainer /> },
      { path: ROUTE.STAFF_MANAGER, element: <TourGuideManagerContainer /> },
      {
        path: ROUTE.TOUR_GUIDE_DETAILS,
        element: <TourGuideDetailsContainer />,
      },
      { path: ROUTE.TOUR_GUIDE_CREATE, element: <TourGuideCreateContainer /> },
      {
        path: ROUTE.BOOKED_TOUR_DETAILS_ADMIN,
        element: <BookedTourDetailsAdminContainer />,
      },
    ],
  },
  {
  ...
  },
  {
    ...
    isPrivate: false,
    role: [ROLE.USER],
    children: [{ path: ROUTE.PROFILE, element: <ProfilePage /> }],
  },
