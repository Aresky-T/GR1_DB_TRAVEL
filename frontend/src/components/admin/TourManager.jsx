        ...
        >
          ...
          <form onSubmit={props.handleSubmit}>
            ...
            <TextField
              ...
              type="text"
              value={props.formData.startAddress}
              onChange={props.handleChangeForm}
              required
              fullWidth
              margin="normal"
            ...
            <TextField
              ...
              type="text"
              value={props.formData.destinationList}
              onChange={props.handleChangeForm}
              required
              fullWidth
              margin="normal"
            ...
            <div className="scheduleDes-tour-form">
              ...
              <ReactQuill
                ...
                theme="snow"
                value={props.formData.scheduleDescription}
                onChange={props.handleChangeForm}
              />
            </div>
            ...
            <TextField
              ...
              label="Tổng số chỗ"
              type="number"
              value={props.formData.totalSeats}
              onChange={props.handleChangeForm}
              required
              fullWidth
              margin="normal"
            ...
            <div className="vehicle-tour-form"
              style={{ display: 'flex' }}
            >
            </div>
            <FormControl sx={{ m: 1, minWidth: 120 }} size="small" className='vehicle-tour-form'>
              ...
              >
                ...
                <MenuItem value="Máy bay, Xe khách">Cả hai</MenuItem>
              </Select>
            </FormControl>

            {
              (props.selectedFiles < 1) && <div className="upload-image-tour-form">
