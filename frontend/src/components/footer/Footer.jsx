    ...
    return (
        <div className='main footer'>
            <div className="footer-item footer-logo">
                ...
                <span className='text-2'>Luôn đồng hành cùng bạn trên những chuyến đi, ngắm nhìn vẻ đẹp bất tận của dải đất hình chữ S</span>
            ...
            <div className="footer-item contact">
                ...
                <div className="contact-item email">
                    <span className='contact-icon'><TbMailOpened /></span>
                ...
                <div className="contact-item facebook">
                    <span className='contact-icon'><FiFacebook /></span>
                    <span className='text-1'>Facebook: </span>
                    <span className='text-2'><a href="https://www.facebook.com/profile.php?id=100078811796824">Anh Tuan</a></span>
                </div>
            </div>
        </div>
    )
