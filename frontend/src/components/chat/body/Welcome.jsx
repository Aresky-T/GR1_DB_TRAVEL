...
import { updateChatStatusField } from '../../../redux/slices/chat.slice';
    ...
    return (
        <div className="chat-box_body--welcome">
            ...
            >
                ...
                <div style={{ display: 'flex', alignItems: 'center', color: 'var(--chat-primary-color)' }}>
            ...
            <div className='chat--welcome_item'>
                <button onClick={() => {
                    dispatch(updateChatStatusField({ key: "isStarted", value: true }))
                }}>
                    Bắt đầu chat
                </button>
            </div>
