...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers(HttpMethod.GET, "/api/v1/book-tour/get-all-by-user").hasAuthority("USER")
                .antMatchers(HttpMethod.GET, "/api/v1/book-tour/get-by-id").hasAnyAuthority("ADMIN", "USER")
                .antMatchers(HttpMethod.GET, "/api/v1/book-tour/get-by-tour/**").hasAuthority("USER")
